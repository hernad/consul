...
### Control plane
At a high level, the primary goal of the control plane in a service mesh is to provide configuration for the data plane. Consul's service mesh is composed of: server agents, client agents, and [consul-dataplane](https://github.com/hernad/consul-dataplane) proxies.
...
The Go client library for this integration exists in the [connect](https://github.com/hernad/consul/tree/main/connect) package.
...
The core of the built-in proxy is implemented in the [connect/proxy](https://github.com/hernad/consul/tree/main/connect/proxy) package, and is launched by the [command/connect/proxy](https://github.com/hernad/consul/tree/main/command/connect/proxy) package.
...
* [consul-dataplane](https://github.com/hernad/consul-dataplane) is used in "agentless" Consul.
* [command/connect/envoy](https://github.com/hernad/consul/tree/main/command/connect/envoy) is used with Consul agents.

...
import (
	...
	grpcmiddleware "github.com/hernad/consul/agent/grpc-middleware"
	"github.com/hernad/consul/agent/grpc-middleware/testutil"
	"github.com/hernad/consul/agent/grpc-middleware/testutil/testservice"

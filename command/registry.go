...
import (
	...
	aclagent "github.com/hernad/consul/command/acl/agenttokens"
	aclam "github.com/hernad/consul/command/acl/authmethod"
	aclamcreate "github.com/hernad/consul/command/acl/authmethod/create"
	aclamdelete "github.com/hernad/consul/command/acl/authmethod/delete"
	aclamlist "github.com/hernad/consul/command/acl/authmethod/list"
	aclamread "github.com/hernad/consul/command/acl/authmethod/read"
	aclamupdate "github.com/hernad/consul/command/acl/authmethod/update"
	aclbr "github.com/hernad/consul/command/acl/bindingrule"
	aclbrcreate "github.com/hernad/consul/command/acl/bindingrule/create"
	aclbrdelete "github.com/hernad/consul/command/acl/bindingrule/delete"
	aclbrlist "github.com/hernad/consul/command/acl/bindingrule/list"
	aclbrread "github.com/hernad/consul/command/acl/bindingrule/read"
	aclbrupdate "github.com/hernad/consul/command/acl/bindingrule/update"
	aclbootstrap "github.com/hernad/consul/command/acl/bootstrap"
	aclpolicy "github.com/hernad/consul/command/acl/policy"
	aclpcreate "github.com/hernad/consul/command/acl/policy/create"
	aclpdelete "github.com/hernad/consul/command/acl/policy/delete"
	aclplist "github.com/hernad/consul/command/acl/policy/list"
	aclpread "github.com/hernad/consul/command/acl/policy/read"
	aclpupdate "github.com/hernad/consul/command/acl/policy/update"
	aclrole "github.com/hernad/consul/command/acl/role"
	aclrcreate "github.com/hernad/consul/command/acl/role/create"
	aclrdelete "github.com/hernad/consul/command/acl/role/delete"
	aclrlist "github.com/hernad/consul/command/acl/role/list"
	aclrread "github.com/hernad/consul/command/acl/role/read"
	aclrupdate "github.com/hernad/consul/command/acl/role/update"
	acltoken "github.com/hernad/consul/command/acl/token"
	acltclone "github.com/hernad/consul/command/acl/token/clone"
	acltcreate "github.com/hernad/consul/command/acl/token/create"
	acltdelete "github.com/hernad/consul/command/acl/token/delete"
	acltlist "github.com/hernad/consul/command/acl/token/list"
	acltread "github.com/hernad/consul/command/acl/token/read"
	acltupdate "github.com/hernad/consul/command/acl/token/update"
	"github.com/hernad/consul/command/agent"
	"github.com/hernad/consul/command/catalog"
	catlistdc "github.com/hernad/consul/command/catalog/list/dc"
	catlistnodes "github.com/hernad/consul/command/catalog/list/nodes"
	catlistsvc "github.com/hernad/consul/command/catalog/list/services"
	"github.com/hernad/consul/command/config"
	configdelete "github.com/hernad/consul/command/config/delete"
	configlist "github.com/hernad/consul/command/config/list"
	configread "github.com/hernad/consul/command/config/read"
	configwrite "github.com/hernad/consul/command/config/write"
	"github.com/hernad/consul/command/connect"
	"github.com/hernad/consul/command/connect/ca"
	caget "github.com/hernad/consul/command/connect/ca/get"
	caset "github.com/hernad/consul/command/connect/ca/set"
	"github.com/hernad/consul/command/connect/envoy"
	pipebootstrap "github.com/hernad/consul/command/connect/envoy/pipe-bootstrap"
	"github.com/hernad/consul/command/connect/expose"
	"github.com/hernad/consul/command/connect/proxy"
	"github.com/hernad/consul/command/connect/redirecttraffic"
	"github.com/hernad/consul/command/debug"
	"github.com/hernad/consul/command/event"
	"github.com/hernad/consul/command/exec"
	"github.com/hernad/consul/command/forceleave"
	"github.com/hernad/consul/command/info"
	"github.com/hernad/consul/command/intention"
	ixncheck "github.com/hernad/consul/command/intention/check"
	ixncreate "github.com/hernad/consul/command/intention/create"
	ixndelete "github.com/hernad/consul/command/intention/delete"
	ixnget "github.com/hernad/consul/command/intention/get"
	ixnlist "github.com/hernad/consul/command/intention/list"
	ixnmatch "github.com/hernad/consul/command/intention/match"
	"github.com/hernad/consul/command/join"
	"github.com/hernad/consul/command/keygen"
	"github.com/hernad/consul/command/keyring"
	"github.com/hernad/consul/command/kv"
	kvdel "github.com/hernad/consul/command/kv/del"
	kvexp "github.com/hernad/consul/command/kv/exp"
	kvget "github.com/hernad/consul/command/kv/get"
	kvimp "github.com/hernad/consul/command/kv/imp"
	kvput "github.com/hernad/consul/command/kv/put"
	"github.com/hernad/consul/command/leave"
	"github.com/hernad/consul/command/lock"
	"github.com/hernad/consul/command/login"
	"github.com/hernad/consul/command/logout"
	"github.com/hernad/consul/command/maint"
	"github.com/hernad/consul/command/members"
	"github.com/hernad/consul/command/monitor"
	"github.com/hernad/consul/command/operator"
	operauto "github.com/hernad/consul/command/operator/autopilot"
	operautoget "github.com/hernad/consul/command/operator/autopilot/get"
	operautoset "github.com/hernad/consul/command/operator/autopilot/set"
	operautostate "github.com/hernad/consul/command/operator/autopilot/state"
	operraft "github.com/hernad/consul/command/operator/raft"
	operraftlist "github.com/hernad/consul/command/operator/raft/listpeers"
	operraftremove "github.com/hernad/consul/command/operator/raft/removepeer"
	"github.com/hernad/consul/command/operator/raft/transferleader"
	"github.com/hernad/consul/command/operator/usage"
	"github.com/hernad/consul/command/operator/usage/instances"
	"github.com/hernad/consul/command/peering"
	peerdelete "github.com/hernad/consul/command/peering/delete"
	peerestablish "github.com/hernad/consul/command/peering/establish"
	peergenerate "github.com/hernad/consul/command/peering/generate"
	peerlist "github.com/hernad/consul/command/peering/list"
	peerread "github.com/hernad/consul/command/peering/read"
	"github.com/hernad/consul/command/reload"
	"github.com/hernad/consul/command/rtt"
	"github.com/hernad/consul/command/services"
	svcsderegister "github.com/hernad/consul/command/services/deregister"
	svcsexport "github.com/hernad/consul/command/services/export"
	svcsregister "github.com/hernad/consul/command/services/register"
	"github.com/hernad/consul/command/snapshot"
	snapinspect "github.com/hernad/consul/command/snapshot/inspect"
	snaprestore "github.com/hernad/consul/command/snapshot/restore"
	snapsave "github.com/hernad/consul/command/snapshot/save"
	"github.com/hernad/consul/command/tls"
	tlsca "github.com/hernad/consul/command/tls/ca"
	tlscacreate "github.com/hernad/consul/command/tls/ca/create"
	tlscert "github.com/hernad/consul/command/tls/cert"
	tlscertcreate "github.com/hernad/consul/command/tls/cert/create"
	"github.com/hernad/consul/command/troubleshoot"
	troubleshootproxy "github.com/hernad/consul/command/troubleshoot/proxy"
	troubleshootupstreams "github.com/hernad/consul/command/troubleshoot/upstreams"
	"github.com/hernad/consul/command/validate"
	"github.com/hernad/consul/command/version"
	"github.com/hernad/consul/command/watch"
